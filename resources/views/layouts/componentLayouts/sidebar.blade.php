        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <li class="nav-item">
                    <ul>
                        <li class="nav-item">
                            <a href="{{ url('employee-info') }}" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Employee</span>
                                </div>
                            </a>
                        </li>
                        
                        {{-- <li class="nav-item">
                            <a href="{{ url('guest-info') }}" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Guest</span>
                                </div>
                            </a>
                        </li> --}}
                        ...
                        <li class="nav-item">
                            <a href="{{ url('apps-todolist') }}" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Wait Staff</span>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                        <!-- <a href="{{ url('dashboard1') }}" class="group">
                                <div class="flex items-center">
                        ...
                        <li class="menu nav-item">
                            <button type="button" class="nav-link group"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Billing and Payment</span>
                                </div>
                            ...
                            <ul x-cloak x-show="activeDropdown === 'invoice'" x-collapse class="sub-menu text-gray-500">
                                <!-- <li>
                                    <a href="{{ url('invoice') }}">Invoices</a>
                                </li> -->
                                {{-- <li>
                                    <a href="/apps/invoice/preview">Preview</a>
                                </li> --}}
                                <!-- <li>
                                    <a href="{{ url('payment-gateway') }}">Payment Gateways</a>
                                </li> -->
                                <!-- <li>
                                    <a href="/apps/invoice/edit">Edit</a>
                                </li> -->
                                <li>
                                    <a href="/apps/invoice/list">Transaction Details</a>
                                </li>
                            </ul>
                        </li>
                        {{-- <li class="nav-item">
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{ 'active': activeDropdown === 'users' }"
                        ...
                        <div class="flex items-center">
                            ...
                            <svg class="group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24"
                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle opacity="0.5" cx="15" cy="6" r="3" fill="#9C603B" />
                                <ellipse opacity="0.5" cx="16" cy="17" rx="5" ry="3" fill="#9C603B" />
                                <circle cx="9.00098" cy="6" r="4" fill="#9C603B" />
                                <ellipse cx="9.00098" cy="17.001" rx="7" ry="4" fill="#9C603B" />
                            </svg>
                            <span
