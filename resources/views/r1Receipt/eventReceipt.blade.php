    ...
    <img src="{{asset('assets/images/anaalogo.png')}}" class="w-32" alt="">
        ...
        <div class="mt-5 sm:mt-10 grid grid-cols-2 sm:grid-cols-3 gap-5">
          <div>
            ...
            <span class="block text-sm font-medium text-gray-800 dark:text-gray-200"><i class="fa-solid fa-peso-sign"></i> {{$reserve->downpayment}}</span>
          </div>
          <!-- End Col -->
